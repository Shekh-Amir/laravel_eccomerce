      ...
      public function placeOrder(Request $request){
        if($request->isMethod('post')){
          ...
          if($data['payment_method']=="COD"){
            ...
            /*echo "<pre>";print_r($productDetails); "<pre/>"; die;*/
            $userDetails=User::where('id',$user_id)->first();
            $userDetails=json_decode(json_encode($userDetails),true);
            /*echo "<pre>";print_r($userDetails); "<pre/>"; die;*/
            //cod for order emails.start....
            $email=$user_email;
            $messageData=[
              'email'=>$email,
            ...
            $message->to($email)->subject('Place order-E-com website!');
          });


            //cod for order emails.end....
         ...
         //redirect user ti paypal page after save order..
